              ...
              <div className="max-h-[360px] overflow-auto">
                ...
                {notifs.map((n) => (
                  <div
                    key={n.id}
                    className={cn(
                      "group flex items-start gap-2.5 px-2.5 py-2 rounded-md hover:bg-surface-hover/50 transition-colors",
                  ...
                  >
                    ...
                    <button
                      ...
                      className="opacity-0 group-hover:opacity-100 h-6 w-6 grid place-items-center rounded text-muted-foreground hover:text-foreground hover:bg-surface-hover transition"
                    >
