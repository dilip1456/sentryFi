      ...
      <div className="w-full max-w-md text-center">
        ...
        <div className="mt-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 text-left">
          ...
          >
            ...
            <div className="mt-3 text-[15px] font-medium text-foreground">Link real accounts</div>
            <div className="mt-1 text-[13px] text-muted-foreground">
              Connect banks and cards securely via Plaid.
            </div>
            <div className="mt-2.5 text-[13px] text-gold group-hover:underline">
              Connect via Plaid →
            </div>
          </button>
          ...
          {onAddManual && (
            ...
            >
              ...
              <div className="mt-3 text-[15px] font-medium text-foreground">Add manually</div>
              <div className="mt-1 text-[13px] text-muted-foreground">
                Mortgage, loans, or any account Plaid can't reach.
              </div>
              <div className="mt-2.5 text-[13px] text-muted-foreground group-hover:text-foreground">
                Add account →
              </div>
            </button>
          )}
          ...
          >
            ...
            <div className="mt-3 text-[15px] font-medium text-foreground">Try demo mode</div>
            <div className="mt-1 text-[13px] text-muted-foreground">
        ...
        <div className="mt-5 flex items-center justify-center gap-4 text-[12.5px] text-muted-foreground flex-wrap">
