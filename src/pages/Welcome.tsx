...
const FEATURES = [
  ...
  },
  {
    ...
    desc: "Overspent on travel this month? Sentry Finance finds your Travel savings account and suggests moving the exact amount over to cover it.",
  },
  {
    icon: "📅",
  ...
  },
  {
    ...
    desc: "Connect any US bank, credit card, loan, or investment account securely. Read-only access — Sentry Finance can never move or touch your money.",
  },
];
...
const HOW = [
  ...
  { step: "02", title: "Tag your accounts", body: "Tell Sentry Finance what each account is for: Spending, Emergency Buffer, Reserve, or Investment. Takes 30 seconds." },
    ...
    <div style={{ fontFamily: "'Inter', system-ui, sans-serif", background: "#111827", color: "#F9F6EF", minHeight: "100vh" }}>
      ...
      <nav style={{ position: "sticky", top: 0, zIndex: 50, borderBottom: "1px solid rgba(255,255,255,0.07)", background: "rgba(17,24,39,0.92)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 20px", height: 60, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <img src="/logo.png" alt="Sentry Finance" style={{ height: 36, width: 36, borderRadius: 8 }} />
            <div>
              <div style={{ fontWeight: 700, fontSize: 15, letterSpacing: "-0.01em" }}>Sentry Finance</div>
      ...
      <section style={{ maxWidth: 780, margin: "0 auto", padding: "80px 24px 64px", textAlign: "center" }}>
        ...
        <div className="shield-glow-wrap" style={{ width: 96, height: 96, margin: "0 auto 32px" }}>
          <img src="/logo.png" alt="Sentry Finance" className="shield-glow-img" style={{ width: 80, height: 80, borderRadius: 18 }} />
        </div>
        ...
        <p style={{ fontSize: "clamp(15px, 2.2vw, 18px)", color: "#8FA3BA", lineHeight: 1.65, maxWidth: 560, margin: "0 auto 36px" }}>
          Your bank shows you a balance. Sentry Finance shows you what that balance{" "}
      ...
      <section style={{ background: "rgba(22,36,63,0.5)", borderTop: "1px solid rgba(255,255,255,0.06)", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
        <div style={{ maxWidth: 1000, margin: "0 auto", padding: "64px 24px", display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(260px,1fr))", gap: 40 }}>
          ...
          <div>
            <div style={{ fontSize: 11, color: "#D4920E", fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 14 }}>What Sentry Finance shows you</div>
      ...
      <section style={{ maxWidth: 700, margin: "0 auto", padding: "72px 24px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: 15, color: "#7A8EA8", lineHeight: 1.7, marginBottom: 36 }}>
          Bank connections are powered by Plaid — the same infrastructure used by Venmo, Robinhood, and thousands of financial apps. Access is strictly read-only: Sentry Finance can see your transactions and balances but cannot initiate transfers, payments, or any account changes. Your credentials never touch our servers.
        </p>
      ...
      <section style={{ background: "linear-gradient(135deg,#16243F 0%,#0D1829 100%)", borderTop: "1px solid rgba(212,146,14,0.2)" }}>
        <div style={{ maxWidth: 700, margin: "0 auto", padding: "72px 24px", textAlign: "center" }}>
          <div className="shield-glow-wrap" style={{ width: 72, height: 72, margin: "0 auto 28px" }}>
            <img src="/logo.png" alt="Sentry Finance" className="shield-glow-img" style={{ width: 60, height: 60, borderRadius: 14 }} />
          </div>
      ...
      <footer style={{ borderTop: "1px solid rgba(255,255,255,0.06)", padding: "28px 24px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
          <div style={{ fontSize: 13, color: "#4B5C70" }}>© 2026 Sentry Finance. Personal use.</div>
